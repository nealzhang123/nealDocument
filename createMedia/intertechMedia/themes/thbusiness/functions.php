...
function par_pagenavi( $range, $max_page ){  
    ...
    if($max_page > 1){
    	...
    	echo '<a href="' . previous_posts( false ) . "\" $attr>". preg_replace( '/&([^#])(?![a-z]{1,8};)/i', '&#038;$1', '<i class="fa fa-angle-left" aria-hidden="true"></i>' ) .'</a>';
        ...
        echo '<a href="' . next_posts( $max_page, false ) . "\" $attr>" . preg_replace('/&([^#])(?![a-z]{1,8};)/i', '&#038;$1', '<i class="fa fa-angle-right" aria-hidden="true"></i>' ) . '</a>';
    }  
} 
