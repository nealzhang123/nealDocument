(function(e) {
    ...
    e.fn.prettyPhoto = function(s) {
        ...
        s = jQuery.extend({
            ...
            custom_markup: "",
            social_tools: '<div class="twitter"><a href="../../../twitter.com/share" class="twitter-share-button" data-count="none">Tweet</a><script type="text/javascript" src="../../../platform.twitter.com/widgets.js"></script></div><div class="facebook"></div>'
        }, s);
        var o = this,
            u = false,
            ...
            $pp_pic_holder.fadeIn(function() {
                ...
                switch (S(pp_images[set_position])) {
                    ...
                    case "vimeo":
                        ...
                        movie = "../../../player.vimeo.com/video/" + n[2] + "@title=0&byline=0&portrait=0";
                        if (settings.autoplay) movie += "&autoplay=1;";
