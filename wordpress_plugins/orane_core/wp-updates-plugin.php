...
new WPUpdatesPluginUpdater_902( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_902') ) {
    class WPUpdatesPluginUpdater_902 {
