...
/*add_action('init','stacktech_register_style');
function stacktech_register_style(){
    wp_enqueue_style('swiper_stylesheet_1',  plugins_url( 'blogtemplates/blogtemplatesfiles/assets/css/swiper.min.css' ));
    wp_enqueue_style('fontawesome_stylesheet_1',  'http://cdn.bootcss.com/font-awesome/4.5.0/css/font-awesome.min.css');
    wp_enqueue_script('swiper_scriptsheet_1',  plugins_url( 'blogtemplates/blogtemplatesfiles/assets/js/swiper.min.js' ));
    wp_enqueue_script('jquery_scriptsheet_1',  'http://cdn.bootcss.com/jquery/3.0.0-beta1/jquery.min.js');
}*/