<?php
/*
Plugin Name: 00-stacktech-visual-composer
Plugin URI: http://www.etongapp.com
Description:the plugin will shou a slider of theme on the home page;shortcode [etongapp-theme]
Version: 1.0
Author: Stacktech
...
require_once('etongapp_theme_show.php');
...
class VCExtendAddonClass {
    ...
    public function integrateWithVC() {
        ...
        */
        vc_map( array(
            "name" => __("etongapp theme show", 'stacktech'),
            "description" => __("Bar tag description text", 'stacktech'),
            "base" => "etongapp-theme",
            "class" => "",
            "controls" => "full",
            ...
            "params" => array(
              ...
              "heading" => __( 'Without parameters, save can be used', 'stacktech'),
              ),
            ),
            'category' => __( 'Stacktech', 'stacktech' ), 
        ) );
    }
