 ...
 */
require_once(STACKTECH_COMMERCE_PLUGIN_PATH . "includes/vendor/alipay/lib/alipay_core.function.php");
require_once(STACKTECH_COMMERCE_PLUGIN_PATH . "includes/vendor/alipay/lib/alipay_md5.function.php");
