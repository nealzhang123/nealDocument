...
//检测语言包
if(file_exists(OSS_API_PATH.DIRECTORY_SEPARATOR.ALI_LANG.'.inc.php')){
	require_once OSS_API_PATH.DIRECTORY_SEPARATOR.ALI_LANG.'.inc.php';
}else{
...
class ALIOSS{
	...
	public function auth($options){
		...
		$request->set_body($options[self::OSS_CACHE_CONTROL]);
        $headers[self::OSS_CACHE_CONTROL] = 'max-age=31536000';
